...
description = "bestpractice: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/bestpractice/blob/master/README.md

License
=======
``bestpractice`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/bestpractice"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
...
VERSION = __version__
PACKAGE_DATA = {'bestpractice': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
