...
# -*- coding: utf-8 -*-
#
# bestpractice documentation build configuration file, created by
...
htmlhelp_basename = 'bestpracticedoc'
...
latex_documents = [
  ('index', 'bestpractice.tex', 'bestpractice Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'bestpractice', 'bestpractice Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'bestpractice', 'bestpractice Documentation',
   'Ariel Rokem', 'bestpractice', 'One line description of project.',
   'Miscellaneous'),
]
