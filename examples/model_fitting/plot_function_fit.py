...
# ------------
#
# First, we'll load some data into bestpractice.
...
# ---------------
#
# With bestpractice, models are created with the :ref:Model class.
